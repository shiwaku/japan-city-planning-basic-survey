...
// 参考実装（mlit-urban-planning-converter/viewer）と同じ地理院最適化ベクトルタイルを使う。
// pale-style.json の source は pmtiles:// で optimal_bvmap を直接読むので、
// main.ts 側で pmtiles プロトコルを登録しておく必要がある。

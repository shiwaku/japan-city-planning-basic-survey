...
**変換**: 2,442 レイヤ / 7,341,101 フィーチャ → PMTiles 1,032 MiB

```
土地利用 525.0MiB(90層) / 建物 336.1MiB(415層) / 人口 62.1MiB(211層) /
自然環境 42.6MiB(152層) / その他 31.4MiB(601層) / 都市施設 15.2MiB(159層) /
産業 14.3MiB(107層) / 災害 3.5MiB(131層) / 景観 1.3MiB(42層) / 地価 0.5MiB(33層)
```
...
8. **`.prj` が無いと ogr2ogr は終了コード 0 で空を書く。** 埼玉県の分割ファイル
